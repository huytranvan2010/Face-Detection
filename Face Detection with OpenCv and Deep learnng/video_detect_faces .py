# USAGE
# python video_detect_faces.py --prototxt deploy.prototxt --model res10_300x300_ssd_iter_140000.caffemodel
...
while True:
    ...
    (h, w) = frame.shape[:2]    # lấy kích cỡ ảnh ban đầu
    ...
    for i in range(detections.shape[2]):
        ...
        cv2.putText(frame, text, (x_min, y), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 255, 0), 1)

    cv2.imshow("Face", frame)
    
    if cv2.waitKey(1) & 0xFF == ord("q"):   # nhan q de thoat
        break
